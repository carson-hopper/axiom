...
public final class TextDisplaySpec {
    ...
    public DisplayTransform rawTransform() {
        return rawTransform;
    }
    ...
    public DisplayBrightness brightness() {
        return brightness;
    }

    public Integer glowColorOverride() {
    ...
    public static final class Builder {
        ...
        // Shared setters
        public Builder billboard(Billboard b) {
            billboard = b;
            return this;
        }
        ...
        public Builder yaw(float degrees) {
            yaw = degrees;
            return this;
        }

        public Builder translation(Vector3 t) {
            translation = t;
            return this;
        }

        public Builder rawTransform(DisplayTransform t) {
            rawTransform = t;
            return this;
        }

        public Builder viewRange(float r) {
            viewRange = r;
            return this;
        }

        public Builder shadowRadius(float r) {
            shadowRadius = r;
            return this;
        }

        public Builder shadowStrength(float s) {
            shadowStrength = s;
            return this;
        }

        public Builder brightness(DisplayBrightness b) {
            brightness = b;
            return this;
        }

        public Builder glowColorOverride(int argb) {
            glowColorOverride = argb;
            return this;
        }

        public Builder clearGlowColorOverride() {
        ...
        public Builder text(ChatComponent t) {
            text = t;
            return this;
        }

        public Builder lineWidth(int w) {
            lineWidth = w;
            return this;
        }
        ...
        public Builder defaultBackground(boolean b) {
            defaultBackground = b;
            return this;
        }

        public Builder textOpacity(byte o) {
            textOpacity = o;
            return this;
        }

        public Builder shadow(boolean s) {
            shadow = s;
            return this;
        }

        public Builder seeThrough(boolean s) {
            seeThrough = s;
            return this;
        }

        public Builder alignment(TextAlignment a) {
            alignment = a;
            return this;
        }
