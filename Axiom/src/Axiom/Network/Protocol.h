...
namespace Axiom {
	...
	namespace Serverbound {
		...
		namespace Login {
			...
			constexpr int32_t LoginHello          = Hello;
			constexpr int32_t Key                = 0x01;
			constexpr int32_t EncryptionResponse  = Key;
		...
		namespace Configuration {
			...
			constexpr int32_t ConfigKeepAlive      = KeepAlive;
		...
		namespace Play {
			...
			constexpr int32_t PlayKeepAlive            = KeepAlive;
