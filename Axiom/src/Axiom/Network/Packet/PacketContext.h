...
namespace Axiom {
    ...
    class PacketContext {
    public:
        PacketContext(ServerConfig& config, EventBus& eventBus,
        ...
        NetworkServer& Server() { return m_Server; }
    ...
    private:
        ...
        KeepAliveManager m_KeepAliveManager{m_Server};
        ItemToBlockMapping m_ItemToBlock;
        LevelTime m_WorldTime{m_Server};
        WorldTicker m_WorldTicker{m_Server};
