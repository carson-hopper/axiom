                ...
                .slot(
                    ...
                    GuiItem.of(
                        ...
                        event -> player.sendMessage(
                            ChatComponent.text("Clicked center!").color(ChatColor.AQUA))))
                .onClose(closedPlayer ->
                    player.sendMessage(ChatComponent.text("GUI closed").color(ChatColor.YELLOW)))
                .build();
        ...
        sender.asPlayer().ifPresent(player -> {
            ...
            GuiItem xpBoost = GuiItem.of(
                Item.of(
                    ...
                    "§aXP Boost",
                    List.of(
                        "§72x XP for 10 minutes", "§eCost: 1000 coins", "§e Click to purchase")),
                event -> {
                    event.player().clearTitle();
                    event.player()
                        .showTitle(
