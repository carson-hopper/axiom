...
public class FabricCommandHandler {
    ...
    public void registerCommand(Object command) {
        ...
        if (cmdAnnotation == null) {
            Axiom.logger()
                .warn(
                    "Command {} has no @Command annotation, skipping",
        ...
        try {
            ...
            if (dispatcher != null) {
                ...
                Axiom.logger()
                    .info("Dynamically registered Brigadier command: {}", cmdAnnotation.name());
            }
        } catch (Exception e) {
    ...
    public void register(Object dispatcherObj) {
        if (!(dispatcherObj instanceof CommandDispatcher)) {
            Axiom.logger()
                .warn(
                    "Expected CommandDispatcher, got {}",
                    dispatcherObj.getClass().getName());
            return;
        }
