...
public record FabricItemDisplayEntity(Display.ItemDisplay entity) implements ItemDisplayEntity {
    ...
    public String nickname() {
        return entity.getCustomName() != null ? entity.getCustomName().getString() : "ItemDisplay";
    }
    ...
    @Override
    public void update(Consumer<ItemDisplaySpec.Builder> editor, int interpolationTicks) {
