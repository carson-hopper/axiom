...
public record FabricBlockDisplayEntity(Display.BlockDisplay entity) implements BlockDisplayEntity {
    ...
    public String nickname() {
        return entity.getCustomName() != null ? entity.getCustomName().getString() : "BlockDisplay";
    }
    ...
    @Override
    public void update(Consumer<BlockDisplaySpec.Builder> editor, int interpolationTicks) {
