...
public class DisplayEntityUtil {
    ...
    public static void applyTextDisplaySpec(Display.TextDisplay entity, TextDisplaySpec spec) {
        try {
            Axiom.logger()
                .debug("TextDisplay spec application is limited in Minecraft 26.1 - consider using"
                    + " datapacks for full customization");
        } catch (Exception e) {
    ...
    public static void applyItemDisplaySpec(Display.ItemDisplay entity, ItemDisplaySpec spec) {
        try {
            Axiom.logger()
                .debug("ItemDisplay spec application is limited in Minecraft 26.1 - consider using"
                    + " datapacks for full customization");
        } catch (Exception e) {
    ...
    public static void applyBlockDisplaySpec(Display.BlockDisplay entity, BlockDisplaySpec spec) {
        try {
            Axiom.logger()
                .debug("BlockDisplay spec application is limited in Minecraft 26.1 - consider using"
                    + " datapacks for full customization");
        } catch (Exception e) {
